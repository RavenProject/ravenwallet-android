...
#include <jni.h>
/* Header for class com_ravencoin_core_BRCoreTransactionOutput */

#ifndef _Included_com_ravencoin_core_BRCoreTransactionOutput
#define _Included_com_ravencoin_core_BRCoreTransactionOutput
#ifdef __cplusplus
extern "C" {
#endif
/*
