...
#include <jni.h>
/* Header for class com_ravencoin_core_BRCoreChainParams */

#ifndef _Included_com_ravencoin_core_BRCoreChainParams
#define _Included_com_ravencoin_core_BRCoreChainParams
#ifdef __cplusplus
extern "C" {
#endif
/*
