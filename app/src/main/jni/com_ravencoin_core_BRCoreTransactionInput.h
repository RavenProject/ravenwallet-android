...
#include <jni.h>
/* Header for class com_ravencoin_core_BRCoreTransactionInput */

#ifndef _Included_com_ravencoin_core_BRCoreTransactionInput
#define _Included_com_ravencoin_core_BRCoreTransactionInput
#ifdef __cplusplus
extern "C" {
#endif
/*
